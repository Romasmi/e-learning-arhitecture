...
const file_billing_billing_proto_rawDesc = "" +
	"\n" +
	"\x15billing/billing.proto\x12\abilling\x1a\x1cgoogle/api/annotations.proto\"<\n" +
	"\aAccount\x12\x17\n" +
	...
	"\x0fupdated_account\x18\x03 \x01(\v2\x10.billing.AccountR\x0eupdatedAccount2\xc3\x02\n" +
	"\x0eBillingService\x12_\n" +
	"\n" +
	"GetAccount\x12\x1a.billing.GetAccountRequest\x1a\x10.billing.Account\"#\x82\xd3\xe4\x93\x02\x1d\x12\x1b/billing/accounts/{user_id}\x12^\n" +
	"\x05TopUp\x12\x15.billing.TopUpRequest\x1a\x10.billing.Account\",\x82\xd3\xe4\x93\x02&:\x01*\"!/billing/accounts/{user_id}/topup\x12p\n" +
	"\bWithdraw\x12\x18.billing.WithdrawRequest\x1a\x19.billing.WithdrawResponse\"/\x82\xd3\xe4\x93\x02):\x01*\"$/billing/accounts/{user_id}/withdrawB\x89\x01\n" +
	"\vcom.billingB\fBillingProtoP\x01Z0github.com/Romasmi/e-learning-arhitecture/gen/go/billing;billing\xa2\x02\x03BXX\xaa\x02\aBilling\xca\x02\aBilling\xe2\x02\x13Billing\\GPBMetadata\xea\x02\aBillingb\x06proto3"
