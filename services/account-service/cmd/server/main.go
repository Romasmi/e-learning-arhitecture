...
import (
	...
	"github.com/elearning/account-service/internal/handler"
	"github.com/elearning/account-service/internal/metrics"
	"github.com/elearning/account-service/internal/repository/postgres"
	"github.com/elearning/account-service/internal/usecase"
	"github.com/elearning/account-service/pkg/kafka"
	"github.com/elearning/account-service/pkg/logger"
	pkgpostgres "github.com/elearning/account-service/pkg/postgres"
...
func main() {
	...
	// Kafka
	producer := kafka.NewProducer(kafkaBrokers, "account.events")
	...
	authClient := authapi.NewAuthServiceClient(authConn)

	// Layers
	repo := postgres.NewAccountRepository(pool)
	uc := usecase.NewAccountUsecase(repo, producer, authClient)
	...
	accountpb.RegisterAccountServiceServer(grpcServer, h)
	...
	err = accountpb.RegisterAccountServiceHandlerFromEndpoint(ctx, mux, grpcAddr, opts)
	if err != nil {
