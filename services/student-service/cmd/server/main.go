...
import (
	...
	"github.com/elearning/student-service/pkg/logger"
	pkgpostgres "github.com/elearning/student-service/pkg/postgres"
...
func main() {
	...
	// Kafka
	producer := kafka.NewProducer(kafkaBrokers, "student.events")
	...
	err = studentpb.RegisterStudentServiceHandlerFromEndpoint(ctx, mux, grpcAddr, opts)
	if err != nil {
